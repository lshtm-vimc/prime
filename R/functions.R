...
#' @param by_calendaryear  logical, output values by calendar year or by year of birth cohort
#' @param use_proportions logical, output data as rates per capita or in totals
#' @param analyseCosts logical, directly run cost-effectiveness analysis on output or not
...
#' @param psa_vals data table with values to use in probabilistic sensitivity analysis, usually .data.batch.psa, generated by RegisterBatchData* functions (currently only RegisterBatchdataGavi)
#' @param disability.weights character, disability weights for cervical cancer from GBD 2017 or GBD 2001
#' @param wb.indicator character, World Bank indicator for GDP/GNI per capita in I$/US$ and current/constant data
...
#' @param prevalence Numeric vector: Age-specific CeCx(16/18) prevalence rates (5-year prevalence) -- referring to people who are alive within 5 years of diagnosis.
...
#' @param canc.inc Integer (optional): Reference year for cancer incidence rates (Globocan: 2018 or 2012)
